    ...
    return (
        <ScrollView>
            <View style={styles.cartTop}>
                <Text style={styles.cartTopText}>My Cart</Text>
                <Text style={styles.cartTopText2}>
                    Items :
            ...
            {cartItems.length == "" && (
                <View style={styles.cartContainer}>
                    <Icon style={styles.cartIcon} name="shopping-cart" />
            ...
            {/* cart items  */}
            {/* <CartCard removeProductHandler={removeProductHandler} cartItems={cartItems} /> */}
                    ...
                    <View key={items.id} style={styles.item}>
                        ...
                        <View style={styles.itemDescripContainer}>
                            ...
                            <View style={styles.quantityAdder}>
                                ...
                                <Text style={styles.addText}>{itemQuantity}</Text>
                                <TouchableOpacity
                            ...
                            <TouchableOpacity
                                onPress={() => removeProductHandler(id)}
                                style={styles.delete}
                            >
                ...
                {cartItems.length > 0 && (
                    <View style={styles.totalContainer}>
                        <View style={styles.total}>
                            ...
                            <Text style={styles.totalPrice}>{cartItems.price}</Text>
                        </View>
